...
export const DOCS: DocSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { code: `import { StaticTokenListProvider, StaticPoolProvider, PoolQuoteProvider } from "solanaxph-sdk";\n\nsolana.tokens.discovery.register(new StaticTokenListProvider({ name: "my-list", entries: tokens }), { default: true });\nsolana.pools.register(new StaticPoolProvider({ name: "my-pools", pools }));\nsolana.swap.register(new PoolQuoteProvider(solana.pools));\n\n// remove by name\nsolana.pools.unregister("my-pools");` },
